...
\begin{landscape}
    \begin{figure}
        \begin{ganttchart}[x unit=.5cm, y unit chart=.5cm, hgrid=true,
...
%           \ganttgroup{Technical spike}{1}{2} \\ %\ganttgroup{} {5}{7} \\
            ...
            \ganttbar{Coding sprints}{8}{18} \\
            \ganttbar{Prototype testing}{11}{11} \ganttbar{}{15}{15} \ganttbar{}{18}{18} \\
            \ganttbar{Christmas Holiday}{19}{20} \\
            \ganttbar{Easter Holiday}{33}{33} \\
%           \ganttlinkedbar{Task 2}{3}{7} \\ % \ganttnewline
%           \ganttmilestone{Milestone}{7} \ganttnewline
            \ganttbar{Evaluation}{29}{38} \\
            \ganttbar{Evaluation}{29}{38} \\
